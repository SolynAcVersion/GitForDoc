...
int main(int argc, char *argv[]) {
  try {
    ...
    if (!std::strcmp(argv[1], "diff"))
      ...
      cmd_add(new_argc, new_argv.data());
    else if (!std::strcmp(argv[1], "commit"))
      cmd_commit(new_argc, new_argv.data());
    else if (!std::strcmp(argv[1], "status"))
      cmd_status(new_argc, new_argv.data());
    else if (!std::strcmp(argv[1], "log"))
      cmd_log(new_argc, new_argv.data());
    else if (!std::strcmp(argv[1], "reset"))
      cmd_reset(new_argc, new_argv.data());
    else if (!std::strcmp(argv[1], "revert"))
      cmd_revert(new_argc, new_argv.data());
    else
      cmd_help();
